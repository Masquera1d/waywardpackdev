...
execute as @s[predicate=1_splatus:holding/weapon/fire_staff,scores={spellbound_f_staff_cooldown=50}] at @s run item modify entity @s weapon.mainhand 1_splatus:fire_staff_ready
execute as @s[predicate=1_splatus:holding/weapon/fire_staff_offhand,scores={spellbound_f_staff_cooldown=50}] at @s run item modify entity @s weapon.offhand 1_splatus:fire_staff_ready
...
execute as @s[scores={spellbound_f_staff=0}] at @s run scoreboard players set @s spellbound_f_staff_cooldown 0
...
execute as @s[scores={spellbound_f_staff_cooldown=..49,spellbound_right_click=1..}] positioned ~ ~1.5 ~ run playsound minecraft:entity.leash_knot.break player @a[distance=..20] ~ ~ ~ 1 .5

scoreboard players set @s[scores={spellbound_right_click=1..}] spellbound_f_staff_cooldown 0
