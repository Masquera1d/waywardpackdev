...
execute if score @s spellbound_golden_ocean_edge_effect2 matches 1 run particle minecraft:shriek 0 ~ ~-1.25 ~ 1 1.5 1 1 15 force @a[distance=..32]
execute if score @s spellbound_golden_ocean_edge_effect2 matches 1 run particle poof ~ ~.5 ~ .75 0 .75 .1 4 force @a[distance=..32]
execute if score @s spellbound_golden_ocean_edge_effect2 matches 1 unless block ~ ~-0.5 ~ lava run function 1_splatus:spellbound/golden_ocean_edge/release_wave3
