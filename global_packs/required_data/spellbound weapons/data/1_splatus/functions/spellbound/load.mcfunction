tellraw @a [{"translate": "Successfully loaded","color": "gray"},{"translate": " Spellbound Weapons v3.4.2","color": "green"}]
...
scoreboard objectives add spellbound_b_cooldown dummy
...
scoreboard objectives add spellbound_crucible_energy custom:damage_dealt
scoreboard objectives add spellbound_crucible_energy_2 custom:damage_dealt_absorbed
...
scoreboard objectives add spellbound_withering_damage custom:damage_dealt
scoreboard objectives add spellbound_withering_damage2 custom:damage_dealt_absorbed
scoreboard objectives add spellbound_withering_hitcool dummy
scoreboard objectives add spellbound_crucible_hitcool dummy

scoreboard objectives add spellbound_withering_movement custom:crouch_one_cm

scoreboard objectives add spellbound_wither_lastused dummy

function 1_splatus:spellbound/other/action/default_settings
