...
# RELEASE !!!
execute if score @s spellbound_moonlight_edge_cooldown matches 60.. if entity @s[predicate=1_splatus:sneaking] unless score @s spellbound_moonlight_edge_fall_speed matches ..-2 run function 1_splatus:spellbound/moonlight_edge/release_heavy_beam
...
execute if score @s spellbound_moonlight_edge_cooldown matches 60 run item modify entity @s weapon.mainhand 1_splatus:moonlight_edge_charged
execute if score @s spellbound_moonlight_edge_cooldown matches 60 run particle end_rod ~ ~1 ~ 0 0 0 .2 5 force @a[distance=..64]
execute if score @s spellbound_moonlight_edge_cooldown matches 1 run item modify entity @s weapon.mainhand 1_splatus:moonlight_edge
