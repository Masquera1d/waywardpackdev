...
execute if score @s spellbound_chainfiring_cooldown matches 101 run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:damage0.5
...
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 112 run summon minecraft:arrow ~ ~1.25 ~ {crit:1b,Tags:["spellbound_player3","spellbound_chainfiring_arrow_despawn"]}
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 114 run summon minecraft:arrow ~ ~1.25 ~ {crit:1b,Tags:["spellbound_player3","spellbound_chainfiring_arrow_despawn"]}
...
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 112 run data modify entity @e[distance=..5,type=arrow,limit=1,sort=nearest] Owner set from entity @s UUID
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 114 run data modify entity @e[distance=..5,type=arrow,limit=1,sort=nearest] Owner set from entity @s UUID
...
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 112 run playsound minecraft:item.crossbow.shoot player @a[distance=..30] ~ ~ ~ 1 1
execute unless entity @s[predicate=!1_splatus:holding/enchant/multishot_offhand,predicate=!1_splatus:holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 114 run playsound minecraft:item.crossbow.shoot player @a[distance=..30] ~ ~ ~ 1 1
