...
execute unless score @s spellbound_crucible_hitcool matches 25.. run scoreboard players add @s spellbound_crucible_hitcool 1

scoreboard players operation @s spellbound_crucible_energy += @s spellbound_crucible_energy_2
scoreboard players set @s spellbound_crucible_energy_2 0
...
execute if score @s spellbound_crucible_energy matches 500.. if entity @s[predicate=1_splatus:sneaking] run function 1_splatus:spellbound/crucible/release_energy
