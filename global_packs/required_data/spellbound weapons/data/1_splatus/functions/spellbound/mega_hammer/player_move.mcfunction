execute unless score @s spellbound_hammer_move matches 1.. positioned as @p[distance=0.0001..,scores={spellbound_hammer=1..}] run function 1_splatus:spellbound/mega_hammer/player_move_vector
