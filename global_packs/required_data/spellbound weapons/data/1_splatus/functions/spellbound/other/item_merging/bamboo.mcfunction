...
execute if score @s spellbound_count matches 1.. run particle block bamboo ~ ~.2 ~ 0 0 0 0 1 force @a[distance=..32] 
...
execute if score @s spellbound_count matches 7.. run function 1_splatus:spellbound/other/item_merging/merged_blowgun
