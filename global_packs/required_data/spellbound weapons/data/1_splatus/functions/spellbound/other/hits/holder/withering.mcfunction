...
execute at @s unless score @s spellbound_fallspeed matches ..-20 as @s[predicate=1_splatus:holding/enchant/sweeping_edge3] positioned ^ ^ ^2.501 as @e[distance=..2.5,sort=nearest,limit=3,type=!#1_splatus:spellbound/misc] at @s run function 1_splatus:spellbound/other/hits/withering_less
...
execute if score @s spellbound_withering_hitcool matches 25.. run scoreboard players add @s spellbound_crucible_energy 30
