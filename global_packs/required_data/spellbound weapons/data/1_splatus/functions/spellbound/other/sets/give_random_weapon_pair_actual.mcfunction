execute as @s run loot spawn ~ ~ ~ loot 1_splatus:other/randomize_21
...
execute if score @s spellbound_randomizer_output matches 12 run function 1_splatus:spellbound/items/blowgun
execute if score @s spellbound_randomizer_output matches 13 run function 1_splatus:spellbound/items/bone_wand
execute if score @s spellbound_randomizer_output matches 14 run function 1_splatus:spellbound/items/chainfiring
execute if score @s spellbound_randomizer_output matches 15 run function 1_splatus:spellbound/items/echo_wand
execute if score @s spellbound_randomizer_output matches 16 run function 1_splatus:spellbound/items/electric_staff
execute if score @s spellbound_randomizer_output matches 17 run function 1_splatus:spellbound/items/endlight
execute if score @s spellbound_randomizer_output matches 18 run function 1_splatus:spellbound/items/fire_staff
execute if score @s spellbound_randomizer_output matches 19 run function 1_splatus:spellbound/items/ice_staff
execute if score @s spellbound_randomizer_output matches 20 run function 1_splatus:spellbound/items/magmus_bow
execute if score @s spellbound_randomizer_output matches 21 run function 1_splatus:spellbound/items/zg_crossbow
