...
particle block orange_concrete ~ ~.75 ~ .25 0 .25 1 5 force @a[distance=..32]

data modify entity @s Item.tag.CrucibleDye set value 2
data modify entity @s Item.tag.CustomModelData set value 47202
data modify entity @s Item.tag.display set value {Name:'{"translate":"Crucible","color":"#F9801D","italic":false}',Lore:['{"translate":"Color: Orange","color":"gray","italic":false}','{"translate":"Spellbound Weapons","color":"#676E75","italic":true}']}
kill @e[sort=nearest,type=item,nbt={Item:{id:"minecraft:orange_dye"}}]