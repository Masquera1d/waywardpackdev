...
execute if score @s spellbound_count matches 4 as @e[distance=..1,type=item] run data merge entity @s {Motion:[0.0,0.04,0.0],NoGravity:1b}


#the light!!!

execute if score @s spellbound_count matches 6 positioned ~ ~160 ~ run function 1_splatus:spellbound/crucible/summon_light_coming_down


execute if score @s spellbound_count matches 10.. run particle end_rod ~ ~.15 ~ 0 0 0 .25 5 force @a[distance=..128]


execute if score @s spellbound_count matches 1..8 run particle enchant ~ ~1.25 ~ 0 0 0 10 50 force @a[distance=..128]


execute if score @s spellbound_count matches 14.. run function 1_splatus:spellbound/other/item_merging/merged_crucible
