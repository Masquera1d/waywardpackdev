...
execute if score @s spellbound_count matches 7 if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:fire_charge"}}] run function 1_splatus:spellbound/other/item_merging/merged_fire_staff

execute if score @s spellbound_count matches 7 if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:packed_ice"}}] run function 1_splatus:spellbound/other/item_merging/merged_ice_staff
execute if score @s spellbound_count matches 7 if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:ice"}}] run function 1_splatus:spellbound/other/item_merging/merged_ice_staff
execute if score @s spellbound_count matches 7 if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:blue_ice"}}] run function 1_splatus:spellbound/other/item_merging/merged_ice_staff



execute if score @s spellbound_count matches 7 if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:glowstone"}}] run function 1_splatus:spellbound/other/item_merging/merged_electric_staff
