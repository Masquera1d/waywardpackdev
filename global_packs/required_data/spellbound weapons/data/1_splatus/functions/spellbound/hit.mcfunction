...
execute unless entity @s[predicate=1_splatus:holding/weapon/crucible] if score @s spellbound_crucible_energy matches 1.. run scoreboard players set @s spellbound_crucible_energy 0
execute unless entity @s[predicate=1_splatus:holding/weapon/withering_sword] if score @s spellbound_withering_damage matches 1.. run scoreboard players set @s spellbound_withering_damage 0
...
execute at @s if score @s spellbound_blazing matches 1 if score @s spellbound_b_cooldown matches 60.. run function 1_splatus:spellbound/other/hits/blazing

#### SEA ####
execute at @s if score @s spellbound_curse matches 1 as @e[distance=1..5,sort=nearest,limit=1,type=!#1_splatus:spellbound/misc] at @s run function 1_splatus:spellbound/other/hits/cursed_sea_blade
#### Golden Sea Blade ####
...
### BONE WAND lol
execute unless entity @s[predicate=!1_splatus:holding/weapon/bone_wand,predicate=!1_splatus:holding/weapon/bone_wand_offhand] run playsound minecraft:block.bone_block.break player @a[distance=..20] ~ ~ ~ .5 1.6


### STAFFS LOL
execute if entity @s[predicate=1_splatus:holding/tag/staff_both] run function 1_splatus:spellbound/other/hits/holder/staffs
...
### CRUCIBLE 
execute at @s as @s[scores={spellbound_crucible=1..},distance=..5] at @s run function 1_splatus:spellbound/other/hits/holder/crucible

### MOONLIGHT 
execute at @s as @s[scores={spellbound_moonlight_edge=1..},distance=..5] at @s if score @s spellbound_moonlight_edge matches 1 run function 1_splatus:spellbound/other/hits/moonlight_edge
